 ...
 */
public class TreinamentoProfissional extends Projeto{
    
    public TreinamentoProfissional(String titulo, List<String> preRequisitos, float valor, int quantidadeHoras, int vagas, String professorResponsavel, String metodoEntrada) {
