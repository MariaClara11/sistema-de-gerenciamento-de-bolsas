...
public class IniciacaoCientifica extends Projeto {
    ...
    public IniciacaoCientifica(String titulo, List<String> preRequisitos, float valor, int quantidadeHoras, int vagas, String professorResponsavel, String metodoEntrada) {
