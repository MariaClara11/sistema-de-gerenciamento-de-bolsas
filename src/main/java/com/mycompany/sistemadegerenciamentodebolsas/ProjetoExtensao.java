...
public class ProjetoExtensao extends Bolsa {
    ...
    public ProjetoExtensao(String titulo, String preRequisitos, List<Disciplina> disciplinasRequisitadas, float valor, int quantidadeHoras, String professorResponsavel) {
